...
description: "Configure YouTube Data API v3 keys, Facebook Graph API tokens, and recommendation settings for the Esquina Shortcodes Plugin from the WordPress admin panel."
---
