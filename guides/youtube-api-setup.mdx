---
title: "Set Up YouTube Data API v3 for the Plugin"
...
If you prefer not to store the API key in the WordPress database, you can define it as a PHP constant. The plugin checks for this constant before falling back to shortcode attributes.
