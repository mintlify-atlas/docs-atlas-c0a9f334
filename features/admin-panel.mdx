---
title: "EsquinaWeb Admin Dashboard and Settings Pages"
sidebarTitle: "Admin Panel"
description: "The Esquina Shortcodes Plugin adds an EsquinaWeb menu to the WordPress admin with a dashboard and dedicated settings pages for YouTube, Facebook, and Recomendaciones."
---
...
<CardGroup cols={2}>
  <Card title="EsquinaWeb" href="https://esquinaweb.com/">
    Main website for the plugin author.
  </Card>
  <Card title="EsquinaGamers" href="https://esquinagamers.com/">
    Gaming content site by the same author.
  </Card>
  <Card title="EsquinaAnime" href="https://esquinaanime.com/">
    Anime content site by the same author.
  </Card>
  <Card title="GitHub Repository" href="https://github.com/Jhon-mantila/pluging-wordpress">
    Source code and releases for this plugin.
  </Card>
</CardGroup>

The dashboard also links to the author's Facebook pages (EsquinaGamers and EsquinaWeb), YouTube channel (EsquinaStudio), TikTok profile, LinkedIn, GitHub profile, the plugin knowledge base, and official documentation.
